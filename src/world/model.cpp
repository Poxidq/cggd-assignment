...
void model::allocate_buffers(const std::vector<tinyobj::shape_t>& shapes)
{
	for (const auto& shape: shapes) {
		...
		std::cout << "vertex_buffer_size: " << vertex_buffer_size * sizeof(cg::vertex) << "\n";
		std::cout << "index_buffer_size: " << index_buffer_size * sizeof(unsigned int) << "\n";

		std::cout << "index_buffer_size: " << index_buffer_size * sizeof(cg::vertex) << "\n";
